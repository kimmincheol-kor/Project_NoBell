...
public class TableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String json_table = TableConnector.ConnectServer("", "/table/read/" + String.valueOf(user_data.UserRsid), "GET");
        ...
        try {
            ...
            int table_people = jsonTable.getInt("table_people");
            ...
            for(int i=0; i<10; i++){
                ...
                for(int j=0; j<10; j++){
                    ...
                    if (table_x == (j+1) && table_y == (i+1)) {
                        ...
                        table_people = jsonTable.getInt("table_people");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                String param = "rs_id=" + user_data.UserRsid + "&table_no=" + new_no + "&table_x=" + position_x + "&table_y=" + position_y + "&table_people=" + new_people + "&operation=create" + "";
                String result_menu = MenuConnector.ConnectServer(param, "/table/update", "POST");
        ...
        // Edit Table Process
            ...
            if (resultCode == 10){
                ...
                // Connect Web Server to Insert Menu Data.
                HttpConnector MenuConnector = new HttpConnector();
                String param = "rs_id=" + user_data.UserRsid + "&table_no=" + new_no + "&table_people=" + new_people + "&operation=update" + "";
                String result_menu = MenuConnector.ConnectServer(param, "/table/update", "POST");
